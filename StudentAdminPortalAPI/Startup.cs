...
namespace StudentAdminPortalAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<StudentAdminContext>(context =>
            context.UseSqlServer(Configuration.GetConnectionString("StudentAdminPortalDb")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //this is used as the angular cannot access the resources folder created here
